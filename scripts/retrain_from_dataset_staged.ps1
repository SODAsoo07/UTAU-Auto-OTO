...
Write-Host "[INFO] This script does NOT stage/copy/move files in dataset_staged."
...
$jobs = @(
    @{ Lang = "korean";   Fmt = "cvvc"; MinMapConf = "0.56"; Epochs = "85"; Batch = "112"; LR = "0.00055" },
    @{ Lang = "korean";   Fmt = "vcv";  MinMapConf = "0.55"; Epochs = "95"; Batch = "96";  LR = "0.00035" },
    @{ Lang = "japanese"; Fmt = "cvvc"; MinMapConf = "0.52"; Epochs = "90"; Batch = "112"; LR = "0.00050" }
)
...
Write-Host ""
Write-Host "[COMPLETE] Retraining pipeline finished."
