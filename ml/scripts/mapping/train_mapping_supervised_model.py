...
def main() -> int:
    ...
    ap = argparse.ArgumentParser(description="Train mapping-supervised LightGBM model.")
    ap.add_argument("--dataset", required=True, help="Input CSV built by build_mapping_supervised_dataset.py")
